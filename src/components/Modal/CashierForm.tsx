...
export default class CashierForm extends Component<Cashier> {
  ...
  handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    customRequest(`CREATE (:Emploee:Cashier{name: '${(formData as Cashier).name}', position: '${(formData as Cashier).position}'})`);
  };

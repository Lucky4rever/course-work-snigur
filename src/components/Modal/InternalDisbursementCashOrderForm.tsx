...
export default class InternalDisbursementCashOrderForm extends Component<DisbursementCashOrder> {
  ...
  handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    customRequest(`
      ...
      MATCH (cs:Cashier{position: "касир"})
      ...
      CREATE (cs)-[dco:DisbursementCashOrder{sum: sum, basis: ("Прибуток за " + toString(totalDate) + " від кондуктора " + cs.name), date: totalDate, EDRPOU: "0084305771", correspondingAccount: "30", destinationCode: "", analyticalAccountingCode: ""}]->(cc)
    `);
  };

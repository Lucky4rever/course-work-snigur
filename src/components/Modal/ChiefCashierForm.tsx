...
export default class ChiefCashierForm extends Component<ChiefCashier> {
  constructor(props: ChiefCashier) {
    super(props);
    this.state = {
      name: props.name,
  ...
  handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    customRequest(`CREATE (:Emploee:ChiefCashier{name: '${(formData as ChiefCashier).name}', position: '${(formData as ChiefCashier).position}'})`);
  };
